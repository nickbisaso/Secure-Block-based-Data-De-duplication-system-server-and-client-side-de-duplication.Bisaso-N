            ...
            if (length == 0) {
                ...
                switch(Integer.parseInt(args[0])) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        throw new RuntimeException("Please enter 1 : Fixed size chunking; 2 : File based chunking; 3 : Content defined chunking");
                }
            } else {
                throw new RuntimeException("Too many parameters, only chunking type and directory are needed.");
            }
        } catch (Exception e) {
